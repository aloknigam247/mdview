...
pub type AstNode<'a> = comrak::nodes::AstNode<'a>;
...
pub trait MdViewExtension: Send + Sync {
    ...
    fn transform(&self, _ast: &mut AstNode<'_>) {}
    fn render_html(&self, _n: &AstNode<'_>, _ctx: &RenderCtx) -> Option<Html> {
        None
    }
    fn render_terminal(&self, _n: &AstNode<'_>, _ctx: &RenderCtx) -> Option<TermChunks> {
        None
    }
