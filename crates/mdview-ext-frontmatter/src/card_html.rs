...
const BASE_CSS: &str = ".mdview-frontmatter{background:var(--mdv-frontmatter-card-bg,#45475a);border:1px solid var(--mdv-frontmatter-card-border,#11111b);border-left:3px solid var(--mdv-accent-mauve,#cba6f7);border-radius:12px;padding:1rem 1.25rem 1rem 1rem;margin:0 0 1.5rem;}.mdview-frontmatter__summary{cursor:pointer;list-style:none;}.mdview-frontmatter__summary::-webkit-details-marker{display:none;}.mdview-frontmatter__title{font-size:1.5rem;font-weight:700;color:var(--mdv-frontmatter-heading-fg,#cdd6f4);}.mdview-frontmatter__draft{background:#ef4444;color:#fff;border-radius:6px;font-size:0.7rem;padding:0.1rem 0.4rem;vertical-align:middle;margin-left:0.5rem;}.mdview-frontmatter__subtitle{color:var(--mdv-frontmatter-subtitle-fg,#bac2de);font-style:italic;margin:0.25rem 0 0.75rem;font-size:1rem;}.mdview-frontmatter__meta{color:var(--mdv-frontmatter-muted-fg,#a6adc8);font-size:0.9rem;margin-bottom:0.5rem;}.mdview-frontmatter__date{color:var(--mdv-accent-peach,#fab387);}.mdview-frontmatter__author{color:var(--mdv-accent-green,#a6e3a1);}.mdview-frontmatter__sep{opacity:0.6;}.mdview-frontmatter__tags{list-style:none;padding:0;display:flex;flex-wrap:wrap;gap:0.4rem;margin:0.5rem 0 0;}.mdview-frontmatter__tags li{background:color-mix(in srgb,var(--mdv-frontmatter-tag-bg,#cba6f7) 25%,transparent);color:var(--mdv-frontmatter-tag-fg,#cba6f7);border-radius:999px;padding:0.15rem 0.6rem;font-size:0.85rem;}.mdview-frontmatter__group{margin-top:0.75rem;}.mdview-frontmatter__group summary{cursor:pointer;color:var(--mdv-frontmatter-muted-fg,#a6adc8);font-family:var(--mdv-font-mono,ui-monospace,monospace);font-size:0.85rem;text-transform:uppercase;letter-spacing:0.05em;}.mdview-frontmatter__group--c0>summary{color:var(--mdv-accent-mauve,#cba6f7);}.mdview-frontmatter__group--c1>summary{color:var(--mdv-accent-teal,#94e2d5);}.mdview-frontmatter__group--c2>summary{color:var(--mdv-accent-blue,#89b4fa);}.mdview-frontmatter__group--c3>summary{color:var(--mdv-accent-peach,#fab387);}.mdview-frontmatter__group--c4>summary{color:var(--mdv-accent-yellow,#f9e2af);}.mdview-frontmatter__group--c5>summary{color:var(--mdv-accent-green,#a6e3a1);}.mdview-frontmatter__group dl,.mdview-frontmatter__other{display:grid;grid-template-columns:max-content 1fr;gap:0.25rem 1rem;margin:0.25rem 0;}.mdview-frontmatter__group dt,.mdview-frontmatter__other dt{color:var(--mdv-frontmatter-muted-fg,#a6adc8);font-family:var(--mdv-font-mono,ui-monospace,monospace);font-size:0.85rem;}.mdview-frontmatter__group dd,.mdview-frontmatter__other dd{color:var(--mdv-fg,#cdd6f4);margin:0;}.mdview-frontmatter__group ul{list-style:disc;padding-left:1.25rem;margin:0.25rem 0;}";
